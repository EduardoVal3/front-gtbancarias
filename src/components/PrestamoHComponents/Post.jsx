// src/components/prestamos/PostPrestamoHipotecario.jsx
...
const PostPrestamoHipotecario = () => {
  ...
  const handleSubmit = async () => {
    ...
    // evitar enviar cuotaMensual al backend
    const { cuotaMensual, ...payload } = formData;
    try {
      await createPrestamoHipotecario(payload);
  ...
  return (
    <Container theme={theme}>
      <FormWrapper>
        ...
        >
          ...
          <SimpleItem
            ...
            editorOptions={{ placeholder: "e.g. Casa, Departamento, Terreno…" }}
          >
            <RequiredRule message="Debe describir la propiedad" />
          </SimpleItem>
      ...
      <PreviewPanel theme={theme}>
        ...
        <p>
          <strong>Propiedad:</strong> {formData.tipoPropiedad}
        </p>
      </PreviewPanel>
    </Container>
  );
