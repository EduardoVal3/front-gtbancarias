...
import { getTransferencias, updateTransferencia } from '../../services/transferenciaService';
...
const PutTransferencia = () => {
  ...
  const onRowUpdating = async (e) => {
    ...
    try {
      await updateTransferencia(id, updatedCliente);
      notify("Transferencia actualizada exitosamente", "success", 3000)
    } catch (err) {
      console.error('Error actualizando cliente:', err);
      notify("No se pudo actualizar la transferencia. Verifique los datos he intente de nuevo.", "error", 4000)
    }
  };
...
export default PutTransferencia;