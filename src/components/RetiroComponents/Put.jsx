...
const PutRetiro = () => {
  ...
  const onRowUpdating = async (e) => {
    ...
    try {
      ...
      notify("Retiro actualizado exitosamente", "success", 3000)
    } catch (err) {
      notify("Error actualizando el retiro", "error", 3000);
      console.error('Error actualizando el retiro:', err);
    }
  };
