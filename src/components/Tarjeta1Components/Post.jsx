...
const PostTarjetaCredito = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await createTarjetaCredito(payload);
      notify("Tarjeta de crédito registrada exitosamente", "success", 4000);
    ...
    <Container theme={theme}>
      <FormWrapper>
        ...
        >
          ...
          >
            <RequiredRule message="El límite es obligatorio." />
            <CustomRule
              message="Debe ser ≥ 0."
      ...
      <PreviewPanel theme={theme}>
        ...
        <p>
          <span>Límite:</span> ${formData.limiteCredito.toFixed(2)}
        </p>
        <p>
          <span>Saldo Pendiente:</span> ${formData.saldoPendiente.toFixed(2)}
        </p>
        <p>
